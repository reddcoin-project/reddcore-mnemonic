...
var reddcore = require('reddcore-lib');
var BN = reddcore.crypto.BN;
var unorm = require('unorm');
var _ = reddcore.deps._;

var pbkdf2 = require('./pbkdf2');
var errors = require('./errors');

var Hash = reddcore.crypto.Hash;
var Random = reddcore.crypto.Random;

var $ = reddcore.util.preconditions;
...
var Mnemonic = function(data, wordlist) {
  ...
  if (Buffer.isBuffer(data)) {
    ...
    throw new reddcore.errors.InvalidArgument('data', 'Must be a Buffer, a string or an integer');
  }
  ent = ent || 128;
  ...
  if (ent % 32 !== 0 || ent < 128) {
    throw new reddcore.errors.InvalidArgument('ENT', 'Values must be ENT > 128 and ENT % 32 == 0');
  }
...
Mnemonic.prototype.toHDPrivateKey = function(passphrase, network) {
  ...
  return reddcore.HDPrivateKey.fromSeed(seed, network);
};
